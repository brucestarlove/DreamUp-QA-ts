...
- [ ] Support key aliases (ArrowUp/Up, ArrowDown/Down, etc.)
- [ ] Add controls schema to config (optional, backward compatible)

#### 4b.1.2 Key Press Improvements
- [ ] Enhance `press` action to support:
...
- [ ] Support common key names: ArrowUp, ArrowDown, ArrowLeft, ArrowRight, KeyW, KeyS, KeyA, KeyD
- [ ] Validate key names against Stagehand's supported keys

#### 4b.1.3 Agnostic Button Clicks
- [ ] Improve click prompts to be game-agnostic:
...
- [ ] Extend controls schema to support:
...
- [ ] Add axis action type: `{ action: "axis", direction: "horizontal", value: 1.0, duration: 500 }`
